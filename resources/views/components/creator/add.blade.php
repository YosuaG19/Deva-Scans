<div class="flex flex-col lg:flex-row w-[95%] gap-4 m-auto mt-[1.5rem]">
    ...
    <div class="w-full lg:w-[70%] flex flex-col justify-between p-4 rounded-lg bg-[#252525] gap-4">
        <span class="flex flex-col">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:gap-4 gap-2">

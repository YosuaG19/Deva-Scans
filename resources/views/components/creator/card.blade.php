<div class="flex flex-col justify-betweenN w-fit">
    <a  href="{{ route('creator.manage', $comic) }}" class="flex relative series-hover w-full md:h-[240px] aspect-[3/4] bg-white overflow-hidden">
    ...
    <div class="flex flex-col justify-between text-white w-full gap-3">
        <span class="flex flex-col">
            ...
            <span class="flex w-full justify-between items-center px-2">
                <p class="text-[.65rem] font-thin rounded hover:bg-[#252525] text-white">{{$comic->chapters->count()}} {{ __('creator.chapters') }}</p>
                <p class="text-[.65rem] font-thin text-white">{{$comic->updated_at->format('d/m/Y')}}</p>
            </span>
        </span>
        ...
        <span class="flex px-2 justify-between">
            <span class="flex flex-col w-full items-center">
                <p class="text-[.65rem] font-semibold text-white">{{$comic->bookmarks->count()}}</p>
                <p class="text-[.5rem] font-thin rounded hover:bg-[#252525] text-white">{{ __('creator.bookmarks') }}</p>
            </span>
            <span class="flex flex-col w-full items-center">
                <p class="text-[.65rem] font-semibold text-white">{{$comic->reactions->count()}}</p>
                <p class="text-[.5rem] font-thin rounded hover:bg-[#252525] text-white">{{ __('creator.likes') }}</p>
            </span>
            <span class="flex flex-col w-full items-center">
                <p class="text-[.65rem] font-semibold text-white">{{$comic->comments->count()}}</p>

<div class="flex flex-col items-center justify-between mx-auto bg-[#252525] rounded-lg h-fit md:w-[80%] w-[95%] p-4 mt-6 gap-6">
    ...
    <div class="flex flex-col items-center w-full gap-8">
        <span class="flex flex-col item-center text-center text-white">
            <h2 class="text-sm font-semibold">{{ __('series.reaction_title') }}</h2>
            <p class="text-[.55rem]">xxx {{ __('series.reactions') }}</p>
        </span>
<div class="flex flex-col items-center mx-auto bg-[#252525] rounded-lg h-fit md:w-[80%] w-[95%] p-6 mt-6 gap-6">
    <span class="flex flex-col item-center text-center text-white">

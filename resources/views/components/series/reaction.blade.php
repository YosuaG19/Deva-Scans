...
<div class="grid md:grid-cols-6 grid-cols-3 gap-y-4 md:w-[70%] lg:w-[50%] w-full">
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[0]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.upvote') }}</label>
    </span>
    ...
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[1]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.downvote') }}</label>
    </span>
    ...
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[2]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.love') }}</label>
    </span>
    ...
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[3]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.fire') }}</label>
    </span>
    ...
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[4]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.angry') }}</label>
    </span>
    ...
    <span class="flex flex-col items-center text-white gap-.5">
        ...
        <p class="text-sm">{{$reaction[5]->total}}</p>
        <label class="font-thin text-[.55rem]">{{ __('series.sad') }}</label>
    </span>
</div>
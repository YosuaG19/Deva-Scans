<div class="flex flex-col md:w-[135px]">
    ...
    <div class="flex flex-col text-white">
        ...
        <a class="w-full text-center text-xs py-1 px-2 rounded bg-[#252525] text-white hover:bg-[#FFD700] hover:text-[#252525] hover:font-semibold">{{ __('series.newest_chapter') }}</a>
    </div>
</div>
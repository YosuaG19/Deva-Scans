    ...
    <div class="flex items-start w-full gap-4">
        ...
        <div class="flex flex-col gap-2 text-white">
            <div class="flex gap-2">
                <a href="" class="text-xs font-semibold">Username</a>
                <span class="text-xs font-light">TimeStamp</span>
            </div>

            <div class="flex text-[.65rem]">
                auris tincidunt lorem vehicula diam pharetra eleifend. Ut auctor pharetra pulvinar. Nullam lacus nulla, luctus sit amet nisl a, aliquet tincidunt lacus. Nullam efficitur sed mauris et rutrum. Ut vulputate lectus massa. Nullam volutpat turpis sed enim viverra, a hendrerit mi rutrum. Phasellus sollicitudin, felis non aliquet dapibus, nibh ante varius odio, congue mattis sapien nulla ornare erat. Nulla dignissim orci et libero posuere molestie. Nunc imperdiet augue eu ipsum interdum, vel facilisis neque imperdiet. Nam rhoncus porta justo vitae tempus. Donec ultricies faucibus ipsum, in vehicula lorem tristique et
            </div>
            ...
            <div class="flex gap-4 items-center">
                <button id="like-btn" class="[&.active_.reaction-icon]:fill-[#FFD700] [&.active_.reaction-text]:text-[#FFD700] flex gap-1 group cursor-pointer">
                    ...
                    <span class="reaction-text group-hover:text-[#FFD700] text-[#656565] text-[.65rem]">xx</span>
                </button>

...
<div class="auth-page min-h-[100vh] flex items-center justify-center">
    ...
    <div class="signup-container rounded-lg flex items-center flex-col gap-2 w-[85%] md:w-[55%] lg:w-[35%] bg-[#05050570] px-12 py-8">
        ...
        <form method="POST" action="{{ route('auth.acc_sign_in') }}" class="flex flex-col items-center gap-2 w-[90%] lg:w-[75%]">
            @csrf
        ...
        <p class="text-white text-xs">
            ...
            <a class="font-semibold text-[#FFD700] hover:text-underline" href="{{ route('auth.sign_up') }}">
                {{ __('auth.signup_here') }}
            </a>
        </p>
    </div>
